...
export default class LenguajeVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by LenguajeParser#bucle.
	visitBucle(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by LenguajeParser#terminar.
	visitTerminar(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by LenguajeParser#condicion.
	visitCondicion(ctx) {
	  return this.visitChildren(ctx);
	}
